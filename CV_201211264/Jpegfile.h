...
public:
	...
	static BYTE * OpenFileToRGB(FILE *infile,               // path to image
							   UINT *width,					// image width in pixels
							   UINT *height);				// image height
	////////////////////////////////////////////////////////////////
	...
	static BOOL RGBToJpegFile(CString fileName,				// path
							...
							BOOL color,						// TRUE = RGB
															// FALSE = Grayscale
							int quality);					// 0 - 100
    static BOOL RGBToOpenFile(FILE *outfile,                // path
							BYTE *dataBuf,					// RGB buffer
							UINT width,						// pixels
							UINT height,					// rows
							BOOL color,						// TRUE = RGB
    ...
    static BOOL RGBFromBGR(BYTE *buf, // made by Jeong Ki Young 15 SEP 1998
                    UINT widthPix, 
                    UINT height);
